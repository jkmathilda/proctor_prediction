...
def train(args):
    ...
    train_df = pd.read_csv("/Users/aliceqi/Documents/GitHub/proctor-prediction-challenge/data/train.csv")
    test_df = pd.read_csv("/Users/aliceqi/Documents/GitHub/proctor-prediction-challenge/data/test.csv")
