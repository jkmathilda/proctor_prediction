...
|---------|----------|---------|------------|
| v1 | Gradient boosting ensemble + Optuna | **0.2431 ± 0.0243** | submission_20260702_1004_v1.csv |
| v2 | SHAP/SHAPIQ analysis + feature selection | 0.2548 | submission_20260630_1449_v2.csv |
| v3 | PINN (twin-head, physics loss in training) | 0.2726 ± 0.0257 | submission_20260630_1630_v3_pinn.csv |
| v4 | PINN (single-head script, hold-out only) | N/A (no full CV) | submission20250630_1544_v4.csv |
